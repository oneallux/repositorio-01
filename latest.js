            ...
            202: (e, t, r) => {
                ...
                class a {
                    static randomizePhoneNumberIfNecessary(e) {
                        ...
                        return e.includes("phone=") ? a.withReplaceQueryParam(e, "phone", o) : e.includes("wa.me") ? `https://wa.me/${o}?${e.split("?")[1]}` : e
                    }
                    static insertAdIdInWppUrl(e, t) {
                        var r;
                        const n = null !== (r = a.getQueryParams(e).get("text")) && void 0 !== r ? r : "Olá",
                            i = t.replace(/[^0-9]/g, ""),
        ...
        class u {
            ...
            static getUtmParameters() {
                ...
                function r(e) {
                    ...
                    return !o || new Date(o) < new Date ? (localStorage.removeItem(e), localStorage.removeItem(m(e)), "") : n
                }
                ...
                const o = r("utm_term"),
                    ...
                    u = function(e) {
                        const t = function() {
                            var e, t;
                            const r = null !== (e = localStorage.getItem("lead")) && void 0 !== e ? e : localStorage.getItem("lead-google");
                            if (!r) return null;
                            const n = JSON.parse(r);
                            return null !== (t = null == n ? void 0 : n._id) && void 0 !== t ? t : null
                        }();
                    ...
                    const t = n(h, e),
                        r = function(e, t, r) {
                            ...
                            function a(e, t, r) {
                                ...
                                return `${n(1===i.length?i[0]:i.slice(0,-1).join(a))}${a}${l}`
                            }
                            const [i, l, s, c, u] = e.split(r);
                            return n([a(i, !0, "jLj"), a(l, !0), a(s, !0), a(c, !0), a(u, !1)], r)
                        }(g ? "" !== S ? S : f : t, 0, e);
        ...
        function p() {
                ...
                document.querySelectorAll("a").forEach((t => {
                    ...
                    if (!(t.href.startsWith("mailto:") || t.href.startsWith("tel:") || t.href.includes("#") || (null === (r = null == i ? void 0 : i.ignoreClasses) || void 0 === r ? void 0 : r.some((e => t.classList.contains(e)))))) {
                        if (n = t.href, ["wa.me/", "api.whatsapp.com/send", "whatsapp:", "link.dispara.ai/", "random.lailla.io/"].some((e => n.includes(e)))) {
                            ...
                            return t.href = a.UrlRebuilder.randomizePhoneNumberIfNecessary(t.href), void(t.href = a.UrlRebuilder.insertAdIdInWppUrl(t.href, null != r ? r : ""))
                        }
                        var n;
                        if (e && d.every((e => t.href.includes(e)))) return;
                        t.href = u.addUtmParametersToUrl(t.href), i.replaceLinks && function(e, t) {
                            var r, n;
            ...
            function t(e) {
                document.querySelectorAll("form").forEach((t => {
                    var r;
                    e && d.every((e => t.action.includes(e))) || (null === (r = null == i ? void 0 : i.ignoreClasses) || void 0 === r ? void 0 : r.some((e => t.classList.contains(e)))) || (t.action = u.addUtmParametersToUrl(t.action), u.getUtmParameters().forEach(((e, r) => {
            ...
            e(),
                function() {
                    ...
                    window.open = function(t, r, n) {
                        var o;
                        return t = u.addUtmParametersToUrl(null !== (o = null == t ? void 0 : t.toString()) && void 0 !== o ? o : ""), e(t, r || "", n || "")
                    }
                }(), r || (t(), function() {
                    const {
                        body: r
