...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [995, 26, 534, 369, 804, 888, 680, 121, 288, 42, 50, 985, 287, 824, 58, 114, 443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 800, 149, 153, 495, 157], {
        9978: (e, t, n) => {
            var s = n(3203),
                i = s(n(5574)),
                o = s(n(9743)),
                ...
                const m = function createHandleElement(e, t) {
                    ...
                    const l = createElement({
                        ...
                        children: [createElement({
                            ...
                            children: [document.createTextNode(r === t ? s("Edit %s", "elementor-pro").replace("%s", n) : s("Save %s", "elementor-pro").replace("%s", n))]
                        })]
                    });
            ...
            class LoopCarousel extends i.default {
                ...
                getSwiperSettings() {
                    ...
                    return "yes" === t.arrows && (e.navigation = {
                        prevEl: n ? ".elementor-swiper-button-next" : ".elementor-swiper-button-prev",
                        nextEl: n ? ".elementor-swiper-button-prev" : ".elementor-swiper-button-next"
        ...
        8208: (e, t, n) => {
            ...
            class TOCHandler extends elementorModules.frontend.handlers.Base {
                ...
                expandBox() {
                    ...
                    this.$element.removeClass(this.getSettings("classes.collapsed")), this.elements.$tocBody.attr("aria-expanded", "true").slideDown(), this.elements.$widgetContainer.css("min-height", e.size + e.unit), this.elements.$collapseButton.trigger("focus")
                }
                collapseBox() {
                    this.$element.addClass(this.getSettings("classes.collapsed")), this.elements.$tocBody.attr("aria-expanded", "false").slideUp(), this.elements.$widgetContainer.css("min-height", "0px"), this.elements.$expandButton.trigger("focus")
                }
                triggerClickOnEnterSpace(e) {
                    13 !== e.keyCode && 32 !== e.keyCode || (e.currentTarget.click(), e.stopPropagation())
                }
